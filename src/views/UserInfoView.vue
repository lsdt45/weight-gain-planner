...
<script setup lang="ts">
	...
	// 确保初始值是正确的类型，并且明确转换为数字类型
	const formModel = reactive({
		gender:
			userStore.userData.gender === 'male' || userStore.userData.gender === 'female'
				? userStore.userData.gender
				: 'male',
		age: userStore.userData.age || null,
		height: userStore.userData.height || null,
		weight: userStore.userData.weight || null,
		activityLevel: userStore.userData.activityLevel || 'moderate',
	});
				...
				<n-space vertical size="large">
					...
					<n-form
						...
						<n-form-item label="活动水平" path="activityLevel">
							<n-select
								v-model:value="formModel.activityLevel"
